...
# Chargement du modèle pré-entraîné et du préprocesseur
model = joblib.load('random_forest_model.pkl')
preprocessor = joblib.load('preprocessor.pkl')  # Assurez-vous que vous avez sauvegardé votre préprocesseur
...
def predict(customer: Customer):
    try:
        ...
        input_data_processed = preprocessor.transform(input_data)  # Assurez-vous que votre préprocesseur a une méthode 'transform'
